...
var romanNumeral = function (integer) {
  ...
  if (integer >= 1000) {
    return "M" + romanNumeral(integer - 1000);
  }
  if (integer >= 900) {
    return "CM" + romanNumeral(integer - 900);
  }
  if (integer >= 800) {
    return "DCCC" + romanNumeral(integer - 800);
  }
  if (integer >= 700) {
    return "DCC" + romanNumeral(integer - 700);
  }
  if (integer >= 600) {
    return "DC" + romanNumeral(integer - 600);
  }
  if (integer >= 500) {
    return "D" + romanNumeral(integer - 500);
  }
  if (integer >= 400) {
    return "CD" + romanNumeral(integer - 400);
  }
  if (integer >= 300) {
    return "CCC" + romanNumeral(integer - 300);
  }
  if (integer >= 200) {
    return "CC" + romanNumeral(integer - 200);
  }
  if (integer >= 100) {
    return "C" + romanNumeral(integer - 100);
  }
  if (integer >= 90) {
    return "XC" + romanNumeral(integer - 90);
  }
  if (integer >= 50) {
    return "L" + romanNumeral(integer - 50);
  }
  if (integer >= 40) {
    return "XL" + romanNumeral(integer - 40);
  }
  if (integer >= 10) {
    return "X" + romanNumeral(integer - 10);
  }
  if (integer >= 9) {
    return "IX" + romanNumeral(integer - 9);
  }
  if (integer >= 5) {
    return "V" + romanNumeral(integer - 5);
  }
  if (integer >= 4) {
    return "IV" + romanNumeral(integer - 4);
  }
  if (integer >= 1) {
    return "I" + romanNumeral(integer - 1);
  }
}
